 ...
 */
{
  ...
  "statisticForm": {
    ...
    //"formatLeftNick": "<img src='xvm://res/icons/flags/{{flag|default}}.png' width='16' height='13'> <img src='xvm://res/icons/xvm/xvm-user-{{xvm-user|none}}.png'> <font color='{{c:r}}' alpha='{{alive?#FF|#80}}'>{{name%.11s~..}} <font face='Consolas'><font size='10'>{{clan}}</font></font></font>",
    "formatLeftNick": "{{py:watchlist.verify('{{name}}','{{clan}}')}} {{name}}",
    //
    // Talvez {{(flag=BR|AR)|default}} ????
    //
    // Display format for the right panel (macros allowed, see macros.txt).
    // Формат отображения для правой панели (допускаются макроподстановки, см. macros.txt).
    //"formatRightNick": "<font color='{{c:r}}' alpha='{{alive?#FF|#80}}'><font face='Consolas'><font size='10'>{{clan}}</font></font> {{name%.11s~..}}</font> <img src='xvm://res/icons/xvm/xvm-user-{{xvm-user|none}}.png'> <img src='xvm://res/icons/flags/{{flag|default}}.png' width='16' height='13'>",
    //"formatRightNick": "{{name}} {{py:blacklist.verifica('{{name}}')}} ",
    "formatRightNick": "{{name}} {{py:watchlist.verify('{{name}}','{{clan}}')}}",
    // Display format for the left panel (macros allowed, see macros.txt).
    // Формат отображения для левой панели (допускаются макроподстановки, см. macros.txt).
